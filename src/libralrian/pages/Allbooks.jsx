  ...
  const [books] = useState([
    {
      ...
      publisher: 'Scribner',
      supplier: 'Book Distributors Inc',
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-semibold text-gray-700">All Books</h2>
                ...
                <tr key={book.id} className="border-t border-gray-200">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex gap-2">
                      <button  className="neumorph-sm p-2" title='Edit' onClick={() => navigate(`/librarian/editbook/${book.id}`)}>
